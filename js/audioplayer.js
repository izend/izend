...
;(function( $, window, document, undefined )
{
	var isTouch		  = 'ontouchstart' in window,
		...
		canPlayType	  = function( type )
		{
			...
			return audioElement.canPlayType && audioElement.canPlayType( type );
		};

	$.fn.audioPlayer = function( options )
	{
		var params		= $.extend( { classPrefix: 'audioplayer' }, options ),
			cssClass	= {},
			cssClassSub =
			{
				playPause:	 	'playpause',
		...
		this.each( function()
		{
			...
			if( typeof audioFile === 'undefined' )
			{
				$this.find( 'source' ).each( function()
				{
					audioFile = $( this ).attr( 'src' );
					audioType = $( this ).attr( 'type' );
					if( typeof audioFile !== 'undefined' && typeof audioType !== 'undefined' && canPlayType( audioType ) )
					{
						isSupport = true;
						return false;
					}
			...
			else if( typeof audioType !== 'undefined' && canPlayType( audioType ) ) isSupport = true;
